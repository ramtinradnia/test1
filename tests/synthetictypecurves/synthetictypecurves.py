...
class TestMethods(unittest.TestCase):
    ...
    def test_calculate_ramp_to_peak_flow(self):
        ...
        type_curve = SyntheticTypeCurve(0, 100, 5, 6, 0, 1, 1, 0)
        # q_zero, q_peak, t_peak, t_plat, k, b, a, p_c
    ...
    def test_calculate_ramp_flow(self):
        ...
        type_curve = SyntheticTypeCurve(0, 100, 5, 6, 1, 1, 1, 0)
        q = type_curve.calculate_ramp_flow()
    ...
    def test_calculate_decline_flow(self):
        ...
        type_curve = SyntheticTypeCurve(0, 10000000, 5, 6, 0, 0, 1, 0)
    ...
    def test_calculate_synthetic_type_curve(self):
        type_curve = SyntheticTypeCurve(32, 100, 5, 6, 0.1, 1, 1, 0)
